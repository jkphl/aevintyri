 ...
 */
class Series extends \Events\Entity\Series implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'events', 'name', 'organizer', 'id', 'sys_deleted', 'sys_author', 'sys_modified', 'sys_creator', 'sys_created', 'email', 'phone', 'fax', 'cell', 'web', 'facebook', 'twitter', 'xing', 'gplus', 'hashtag', 'description', 'abstract', 'image');
        }
