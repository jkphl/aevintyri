 ...
 */
class Usergroup extends \Auth\Entity\Usergroup implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'name', 'active', 'id', 'sys_deleted', 'sys_author', 'sys_modified', 'sys_creator', 'sys_created');
        }
