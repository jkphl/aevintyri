 ...
 */
class Presenter extends \Events\Entity\Presenter implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'name', 'tags', 'links', 'sessions', 'id', 'sys_deleted', 'sys_author', 'sys_modified', 'sys_creator', 'sys_created', 'email', 'phone', 'fax', 'cell', 'web', 'facebook', 'twitter', 'xing', 'gplus', 'image', 'hashtag', 'description', 'abstract');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Presenter $proxy) {
