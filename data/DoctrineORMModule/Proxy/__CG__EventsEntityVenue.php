...
class Venue extends \Events\Entity\Venue implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'name', 'rooms', 'id', 'sys_deleted', 'sys_author', 'sys_modified', 'sys_creator', 'sys_created', 'street_address_1', 'street_address_2', 'co', 'postbox', 'postal_code', 'locality', 'region', 'country', 'latitude', 'longitude', 'hashtag', 'description', 'abstract', 'image');
        }
